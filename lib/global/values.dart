...
final Map messages = const {
  ...
  // 1: 'Es ist sehr schwierig, das Weinen zu hören, aber bald wird Ihr Baby nachts besser schlafen',
  2: 'This will be good for both you and your baby. Hang in there.',
  // 2: 'Das wird sowohl für dich als auch für dein Baby gut sein. Halte durch.',
  3: 'You are doing so well. It\'s just a few more nights.',
  // 3: 'Du machst das so gut. Es sind nur noch ein paar Nächte.',
};
